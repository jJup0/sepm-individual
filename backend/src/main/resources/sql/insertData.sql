...
VALUES (-1, 'Wendy', 'first horse', '2000-01-01', 'female', -1, null, null),
       ...
       (-6, 'Sugar', '', '2005-01-01', 'male', -2, -4, -5),
       (-7, 'Lady', '', '2006-01-01', 'female', null, -3, -6),
       (-8, 'Missy', '', '2007-01-01', 'male', -3, -6, -7),
       (-9, 'Dakota', '', '2008-01-01', 'male', -4, null, null),
       (-10, 'Cash', '', '2009-01-01', 'male', null, null, null)
;
DELETE
FROM owner
where id < 0;
